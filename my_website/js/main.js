//the main js for Module 3 by Yunlei Liang
...
//the function shows the GeoJSON data to the console log
function jQueryAjax(){
    ...
    $.ajax("data/MegaCities.geojson", {
        dataType: "json",
		//if succeed, callback the function to print the data to the console
        success: function(response){
            mydata = response;
			
			//the data can be accessed inside the function
			console.log("This is the data:",mydata)
        }
    });

    //check the data
	//the data cannot be accessed since it is outside the function
    console.log("This is undefined:",mydata);
};

//the function shows the GeoJSON data to the html
function debugAjax(){
	//define a variable to hold the data
	var mydata;

	//basic jQuery ajax method to get the geojson data
	$.ajax("data/MegaCities.geojson", {
		dataType: "json",
		//if succeed getting the data, conduct the function follows
		success: function(response){
			//store the got data in 'mydata'
			mydata = response;
